...
<head>
    ...
    <link href="../static/css/patch/patch7.css" rel="stylesheet">
...
<section>
    ...
    <div class="mainpanel" >
        ...
        <div class="pageheader">
            ...
            <a href="mall.html"><h2 id="mall-title"></h2></a>
        </div>
        ...
        <div class="contentpanel">
            <div class="row user">
                ...
                <div class="col-sm-3">
                    <div class="row">
                        <span id="user-name">${databoxUser.userName}</span>
                    ...
                    <div class="row user-group">
                        <span>${databoxUser.sex=='1'?'男':'女'}</span><span>汉族</span><span>${userAge}岁</span><span>白领</span><em>辣妈群</em>

                    </div>
                    <div class="row user-location">
                        <span class="glyphicon glyphicon-map-marker"></span>
                        <span>${databoxUser.address==null?"闵行区":databoxUser.address}</span>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div  class="user-more" id="user-bought">
                        <h3>贡献客单价</h3>
                        <p>
                            <span class="fa fa-cny">${userCountPay}元</span>
                        </p>
                    </div>
                </div>
                <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                    <div  class="user-more" id="user-pay-level">
                        ...
                        <p>
                            <span class="fa fa-cny">${1+(9000-dataBoxCountVo.dataTotal)/9000}元</span>
                        </p>
                ...
                <div class="col-sm-12 user-info-panel">
                    ...
                    <div class="row user-info-detail">
                        <div class="col-sm-6">
                            ...
                            <p class="bg-light"><span>地址</span>${databoxUser.address==null?"闵行区":databoxUser.address}</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="bg-light"><span>婚姻史</span>已婚</p>
                            <p class=""><span>是否有子女</span>1</p>
                            <p class="bg-light"><span>车</span>
                            <c:if test="${databoxUser.mobile=='13472661648'}" >
                                大众-${parkingNo}
                            </c:if>
                            <c:if test="${databoxUser.mobile=='15800957420'}" >
                                本田-${parkingNo}
                            </c:if>
                            </p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 user-info-panel" >
                    ...
                    <div class="row pet">
                        ...
                        <div class="use-rage-label pet-info" id="pet-info-1-sub">
                            <dl>
                                <dt>朋友关联度</dt>
                                <dd>79%</dd>
                            </dl>
                        ...
                        <div class="use-rage-label pet-info " id="pet-info-2-sub">
                            <dl>
                                <dt>偏好类型</dt>
                                <dd>购物 就餐 美容</dd>
                            </dl>
                        ...
                        <div class="use-rage-label pet-info" id="pet-info-3-sub">
                            <dl>
                                <dt>来场时间</dt>
                                <dd>假期或者周末</dd>
                        ...
                        <div class="use-rage-label pet-info" id="pet-info-4-sub">
                            <dl>
                                <dt>偏好的广告</dt>
                                <dd>母婴类活动</dd>
                                <dd>优惠券</dd>
