...
<>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
            <h2><i class="fa fa-bullseye" style="padding: 4.5px 5.5px;" ></i>定位</h2>
    ...
    <form action="/smdaqp/ibea/Ibeacon.do" method="post">
                      ...
                      <div class="panel-heading">
                         ...
                         <table>                          	
	                         <tr>
	                        	...
	                        	<td>&nbsp;</td>--%>
	                         	<td>mac：</td><td><input type="text" id="deviceno" name="deviceno" /></td>
	                         	<td>&nbsp;</td>
	                         	<td>&nbsp;&nbsp;手机号：</td><td><input type="text" id="mobile" name="mobile"/></td>
	                         	<td>&nbsp;&nbsp;区域：</td><td>
										<select class="form-control" id="area-select" onchange="check(this.options[this.options.selectedIndex].text)" >
                                            <option selected="selected" value="">全部</option>
                                            <option  value="A">门口</option>
                                            <option  value="B">会议室</option>
                                            <option  value="C">产品部</option>
                                            <option  value="D">开发部</option>
                                            <option  value="E">总经理办公室</option>
                                </select></td>
	                         	<!--<td>&nbsp;</td>
	                         	<td>&nbsp;&nbsp;进入时间：</td><td><input type="text" id="startTime" name="startTime"/></td>
	                         	<td>&nbsp;</td>
	                         	<td>&nbsp;&nbsp;&nbsp;—&nbsp;&nbsp;&nbsp;</td>
                                  ...
                                  <tbody>
                                   <c:forEach items="${paginator.results}" var="resutl" varStatus="index">
		                          	      <tr>
		                          	     	  ...
		                          	     	  <td>${resutl.area}</td>
		                                      <td><fmt:formatDate value="${resutl.creadedDate}" pattern="MM-dd HH:mm:ss" /></td>
		                                      <td>${resutl.resource}</td>
		                                      <td>${fn:substring(resutl.deviceno,0,17)}</td>
		                                      <td>${fn:substring(resutl.ibeaconno,24,40)}</td>
		                                  </tr>
                                    </c:forEach>
                                  </tbody>
                              </table>
                                      ...
                                      <c:forEach items="${paginator.results}" var="resutl" varStatus="index">
                                          <c:if test="${ index.index<= (paginator.items/paginator.itemsPerPage) }" >
                                              <c:if test="${index.index == 0}" >
                                                  ...
                                                  <c:if test="${paginator.page != 1}" >
                                                      <li><a href="/smdaqp/ibea/Ibeacon.do?page=${paginator.page - 1}"><i class="fa fa-angle-left"></i></a></li>
                                                  </c:if>
                                              </c:if>
                                              <c:if test="${paginator.page == index.index + 1}" >
                                                  <li class="active"><a href="/smdaqp/ibea/Ibeacon.do?page=${paginator.page}">${index.index +1}</a></li>
                                              </c:if>
                                              <c:if test="${paginator.page != index.index +1}" >
                                                  <li><a href="/smdaqp/ibea/Ibeacon.do?page=${index.index+1}">${index.index +1}</a></li>
                                              </c:if>
                                              <c:if test="${(index.index +1) > (paginator.items/paginator.itemsPerPage)}" >
                                                  ...
                                                  <c:if test="${paginator.page < (paginator.items/paginator.itemsPerPage)}" >
                                                      <li><a href="/smdaqp/ibea/Ibeacon.do?page=${paginator.page + 1}"><i class="fa fa-angle-right"></i></a></li>
                                                  </c:if>
                                              </c:if>
                                          </c:if>
                                      </c:forEach>
