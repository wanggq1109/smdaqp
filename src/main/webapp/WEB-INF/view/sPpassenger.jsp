...
<div class="mainpanel">
    ...
    <div class="pageheader">
        <h2><i class="fa fa-users" style="padding: 4.5px 5.5px;"></i>客流</h2>
        <div class="breadcrumb-wrapper">
            <span class="label">当前系统:</span>
            <ol class="breadcrumb">
                <li><a <%--href="index_pl_shops.html"--%>>CRM S+</a></li>
                <li class="active">客流</li>
            </ol>
        </div>
    </div>
    <form action="/smdaqp/splus/passenger.do" method="post">
        <div class="contentpanel">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">客流搜索</h4>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <h3 class="subtitle mt10 col-sm-3">客流数据列表</h3>
                            </div><!--col-md-12-->

                            <div class="col-sm-12">
                                <%--<form class="form-horizontal clearfix" role="form" action="/smdaqp/splus/passenger.do" method="post">--%>
                                    <div class="form-group col-sm-3 col-md-3">
                                    ...
                                    <div class="form-group col-sm-5 col-md-5">
                                        <label class="col-sm-3 control-label " for="sum-start">指标</label>
                                        <div class="col-sm-4">
                                            <input   type="text" class="form-control col-sm-8" id="sum-start"  name="target" placeholder="请输入">
                                        </div><%--
                            ...
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <c:forEach items="${paginator.results}" var="resutl" varStatus="index">
                                        <tr>
                                            <td>${index.index +1}</td>
                                            <td><a href="/smdaqp/smdaqpController/mall.do?mallId=${resutl.mallId}">${resutl.mallName}</a></td>
                                            <td>${resutl.target}</td>
                                            <td><fmt:formatDate value="${resutl.getInfoTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                            <td>${resutl.amount}</td>
                                            <td><fmt:formatDate value="${resutl.leaveTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                        ...
                                        <c:forEach items="${paginator.results}" var="resutl" varStatus="index">
                                            <c:if test="${ index.index<= (paginator.items/paginator.itemsPerPage) }" >
                                                <c:if test="${index.index == 0}" >
                                                    ...
                                                    <c:if test="${paginator.page != 1}" >
                                                        <li><a href="/smdaqp/splus/passenger.do?page=${paginator.page - 1}"><i class="fa fa-angle-left"></i></a></li>
                                                    </c:if>
                                                </c:if>
                                                <c:if test="${paginator.page == index.index + 1}" >
                                                    <li class="active"><a href="/smdaqp/splus/passenger.do?page=${paginator.page}">${index.index +1}</a></li>
                                                </c:if>
                                                <c:if test="${paginator.page != index.index +1}" >
                                                    <li><a href="/smdaqp/splus/passenger.do?page=${index.index+1}">${index.index +1}</a></li>
                                                </c:if>
                                                <c:if test="${(index.index +1) > (paginator.items/paginator.itemsPerPage)}" >
                                                    ...
                                                    <c:if test="${paginator.page < (paginator.items/paginator.itemsPerPage)}" >
                                                        <li><a href="/smdaqp/splus/passenger.do?page=${paginator.page + 1}"><i class="fa fa-angle-right"></i></a></li>
                                                    </c:if>
                                                </c:if>
                                            </c:if>
                                        </c:forEach>
